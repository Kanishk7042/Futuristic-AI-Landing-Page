...
const translateSmallY=useTransform(springY,[0,1],['-200%','200%']);
  return <section ref={sectionRef} >
    <div className="container">
      ...
      <p className="text-center text-lg md:text-xl mt-8 max-w-3xl mx-auto">Harness the power of AI with Sphereal. Elevate your productivity and streamline your workflow with our cutting-edge AI chat platform.  </p>
      ...
      <Planet size="md" color="teal" className="-translate-y-[342px] translate-x-[488px] -rotate-135"/>
        ...
        <div className="absolute  left-0 z-10 top-[30%] -translate-x-10 hidden lg:block">
          <motion.div className="bg-gray-800/70 backdrop-blur-md border-gray-700 rounded-xl p-4 w-72" style={{
            ...
            <div className="text-right text-gray-400 text-sm font-semibold">1m ago
        ...
        <div className="absolute  right-0 z-10 top-[50%] translate-x-10 hidden lg:block">
          <motion.div className="bg-gray-800/70 backdrop-blur-md border-gray-700 rounded-xl p-4 w-72" style={{
            ...
            <div>
              <strong>Sphereal:</strong> I created one based on videos from Frontend Tribe! </div>
