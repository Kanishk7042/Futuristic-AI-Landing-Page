...
<motion.div className=" absolute inset-0 "  initial={{rotate:rotate,
...
animate={{
  ...
  <motion.div className=" inline-flex size-10 md:size-14 items-center justify-center border border-[var(--color-border)] rounded-lg absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-0 bg-gray-950" initial={{
   translate:` -50%,-50%`,
    rotate:-rotate,
